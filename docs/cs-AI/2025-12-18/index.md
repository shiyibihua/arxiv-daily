---
layout: default
title: arXiv 中文要点汇总 - cs.AI - 2025-12-18
---
...
<a href="#支柱九具身大模型-embodied-foundation-models" class="interest-badge">支柱九：具身大模型 (Embodied Foundation Models) (27 🔗4)</a>
...
<h2 id="支柱九具身大模型-embodied-foundation-models">🔬 支柱九：具身大模型 (Embodied Foundation Models) (27 篇)</h2>
...
<tr>
  <td>1</td>
  <td><a href="./papers/251216245v1-alignmerge-alignment-preserving-large-language-model-merging-via-fis.html">AlignMerge - Alignment-Preserving Large Language Model Merging via Fisher-Guided Geometric Constraints</a></td>
  <td>AlignMerge：通过Fisher引导的几何约束实现对齐保持的大语言模型合并</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">foundation model</span> <span class="paper-tag">instruction following</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16245v1" data-paper-url="./papers/251216245v1-alignmerge-alignment-preserving-large-language-model-merging-via-fis.html" onclick="toggleFavorite(this, '2512.16245v1', 'AlignMerge - Alignment-Preserving Large Language Model Merging via Fisher-Guided Geometric Constraints')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>2</td>
...
<tr>
  <td>3</td>
  <td><a href="./papers/251216650v1-prefix-probing-lightweight-harmful-content-detection-for-large-langu.html">Prefix Probing: Lightweight Harmful Content Detection for Large Language Models</a></td>
  <td>提出Prefix Probing，以低延迟、低成本方式检测大语言模型中的有害内容。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16650v1" data-paper-url="./papers/251216650v1-prefix-probing-lightweight-harmful-content-detection-for-large-langu.html" onclick="toggleFavorite(this, '2512.16650v1', 'Prefix Probing: Lightweight Harmful Content Detection for Large Language Models')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>4</td>
...
<tr>
  <td>7</td>
  <td><a href="./papers/251216531v1-scaling-laws-for-energy-efficiency-of-local-llms.html">Scaling Laws for Energy Efficiency of Local LLMs</a></td>
  <td>针对本地LLM，揭示CPU能效缩放规律，并提出量子启发压缩优化方案。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16531v1" data-paper-url="./papers/251216531v1-scaling-laws-for-energy-efficiency-of-local-llms.html" onclick="toggleFavorite(this, '2512.16531v1', 'Scaling Laws for Energy Efficiency of Local LLMs')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>8</td>
...
<tr>
  <td>9</td>
  <td><a href="./papers/251216250v1-amuse-audio-visual-benchmark-and-alignment-framework-for-agentic-mul.html">AMUSE: Audio-Visual Benchmark and Alignment Framework for Agentic Multi-Speaker Understanding</a></td>
  <td>AMUSE：用于Agentic多说话人理解的音视频基准和对齐框架</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16250v1" data-paper-url="./papers/251216250v1-amuse-audio-visual-benchmark-and-alignment-framework-for-agentic-mul.html" onclick="toggleFavorite(this, '2512.16250v1', 'AMUSE: Audio-Visual Benchmark and Alignment Framework for Agentic Multi-Speaker Understanding')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>10</td>
  <td><a href="./papers/251216083v1-scaling-text2sql-via-llm-efficient-schema-filtering-with-functional-.html">Scaling Text2SQL via LLM-efficient Schema Filtering with Functional Dependency Graph Rerankers</a></td>
  <td>提出GRaST，通过LLM高效的模式过滤和函数依赖图重排序，扩展Text2SQL到大规模数据库。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16083v1" data-paper-url="./papers/251216083v1-scaling-text2sql-via-llm-efficient-schema-filtering-with-functional-.html" onclick="toggleFavorite(this, '2512.16083v1', 'Scaling Text2SQL via LLM-efficient Schema Filtering with Functional Dependency Graph Rerankers')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>11</td>
  <td><a href="./papers/251216750v1-plausibility-as-failure-how-llms-and-humans-co-construct-epistemic-e.html">Plausibility as Failure: How LLMs and Humans Co-Construct Epistemic Error</a></td>
  <td>揭示LLM与人类交互中认知错误的共建机制，强调评估的解释性视角</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16750v1" data-paper-url="./papers/251216750v1-plausibility-as-failure-how-llms-and-humans-co-construct-epistemic-e.html" onclick="toggleFavorite(this, '2512.16750v1', 'Plausibility as Failure: How LLMs and Humans Co-Construct Epistemic Error')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>12</td>
  <td><a href="./papers/251216701v1-cyber-humanism-in-education-reclaiming-agency-through-ai-and-learnin.html">Cyber Humanism in Education: Reclaiming Agency through AI and Learning Sciences</a></td>
  <td>提出教育领域“赛博人文主义”框架，通过AI和学习科学重塑能动性</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16701v1" data-paper-url="./papers/251216701v1-cyber-humanism-in-education-reclaiming-agency-through-ai-and-learnin.html" onclick="toggleFavorite(this, '2512.16701v1', 'Cyber Humanism in Education: Reclaiming Agency through AI and Learning Sciences')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>13</td>
  <td><a href="./papers/251216661v1-microsoft-academic-graph-information-retrieval-for-research-recommen.html">Microsoft Academic Graph Information Retrieval for Research Recommendation and Assistance</a></td>
  <td>提出基于注意力机制的子图检索器，用于科研推荐和辅助，提升知识推理能力。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16661v1" data-paper-url="./papers/251216661v1-microsoft-academic-graph-information-retrieval-for-research-recommen.html" onclick="toggleFavorite(this, '2512.16661v1', 'Microsoft Academic Graph Information Retrieval for Research Recommendation and Assistance')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>14</td>
...
<tr>
  <td>15</td>
  <td><a href="./papers/251216465v1-cupilot-a-strategy-coordinated-multi-agent-framework-for-cuda-kernel.html">cuPilot: A Strategy-Coordinated Multi-agent Framework for CUDA Kernel Evolution</a></td>
  <td>cuPilot：一种策略协调的多智能体框架，用于CUDA内核演化</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16465v1" data-paper-url="./papers/251216465v1-cupilot-a-strategy-coordinated-multi-agent-framework-for-cuda-kernel.html" onclick="toggleFavorite(this, '2512.16465v1', 'cuPilot: A Strategy-Coordinated Multi-agent Framework for CUDA Kernel Evolution')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>16</td>
...
<tr>
  <td>17</td>
  <td><a href="./papers/251216442v1-tib-aissistant-a-platform-for-ai-supported-research-across-research-.html">TIB AIssistant: a Platform for AI-Supported Research Across Research Life Cycles</a></td>
  <td>TIB AIssistant：一个支持研究全生命周期的人工智能研究平台</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16442v1" data-paper-url="./papers/251216442v1-tib-aissistant-a-platform-for-ai-supported-research-across-research-.html" onclick="toggleFavorite(this, '2512.16442v1', 'TIB AIssistant: a Platform for AI-Supported Research Across Research Life Cycles')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>18</td>
...
<tr>
  <td>21</td>
  <td><a href="./papers/251216310v1-agent-tools-orchestration-leaks-more-dataset-benchmark-and-mitigatio.html">Agent Tools Orchestration Leaks More: Dataset, Benchmark, and Mitigation</a></td>
  <td>揭示Agent工具编排中的隐私泄露风险，并提出TOP-Bench基准与PEP缓解方法</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16310v1" data-paper-url="./papers/251216310v1-agent-tools-orchestration-leaks-more-dataset-benchmark-and-mitigatio.html" onclick="toggleFavorite(this, '2512.16310v1', 'Agent Tools Orchestration Leaks More: Dataset, Benchmark, and Mitigation')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>22</td>
...
<tr>
  <td>28</td>
  <td><a href="./papers/251216917v1-generative-adversarial-reasoner-enhancing-llm-reasoning-with-adversa.html">Generative Adversarial Reasoner: Enhancing LLM Reasoning with Adversarial Reinforcement Learning</a></td>
  <td>提出生成对抗推理器，通过对抗强化学习提升LLM的推理能力，尤其在数学问题上。</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16917v1" data-paper-url="./papers/251216917v1-generative-adversarial-reasoner-enhancing-llm-reasoning-with-adversa.html" onclick="toggleFavorite(this, '2512.16917v1', 'Generative Adversarial Reasoner: Enhancing LLM Reasoning with Adversarial Reinforcement Learning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>29</td>
...
<tr>
  <td>31</td>
  <td><a href="./papers/251216406v1-hypernetworks-that-evolve-themselves.html">Hypernetworks That Evolve Themselves</a></td>
  <td>提出自引用图超网络，实现无需外部优化器的神经网络自进化。</td>
  <td class="tags-cell"><span class="paper-tag">locomotion</span> <span class="paper-tag">reinforcement learning</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16406v1" data-paper-url="./papers/251216406v1-hypernetworks-that-evolve-themselves.html" onclick="toggleFavorite(this, '2512.16406v1', 'Hypernetworks That Evolve Themselves')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>32</td>

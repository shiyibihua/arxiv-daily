---
layout: default
title: arXiv 中文要点汇总 - eess.SY - 2025-12-18
---
...
<a href="#支柱八物理动画-physics-based-animation" class="interest-badge">支柱八：物理动画 (Physics-based Animation) (2)</a>
...
<tr>
  <td>5</td>
  <td><a href="./papers/251216402v1-machine-learning-based-optimal-control-for-colloidal-self-assembly.html">Machine Learning-based Optimal Control for Colloidal Self-Assembly</a></td>
  <td>提出基于机器学习的最优控制框架，实现胶体自组装的精确控制</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16402v1" data-paper-url="./papers/251216402v1-machine-learning-based-optimal-control-for-colloidal-self-assembly.html" onclick="toggleFavorite(this, '2512.16402v1', 'Machine Learning-based Optimal Control for Colloidal Self-Assembly')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>


[⬅️ 返回 eess.SY 首页](../index.html) · [🏠 返回主页](../../index.html)
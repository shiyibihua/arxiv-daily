---
layout: default
title: arXiv 中文要点汇总 - cs.CL - 2025-12-18
---
...
<a href="#支柱九具身大模型-embodied-foundation-models" class="interest-badge">支柱九：具身大模型 (Embodied Foundation Models) (10 🔗2)</a>
...
<tr>
  <td>4</td>
  <td><a href="./papers/251216378v1-hearing-to-translate-the-effectiveness-of-speech-modality-integratio.html">Hearing to Translate: The Effectiveness of Speech Modality Integration into LLMs</a></td>
  <td>首个SpeechLLM综合评测：对比端到端与级联架构语音翻译性能</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">foundation model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16378v1" data-paper-url="./papers/251216378v1-hearing-to-translate-the-effectiveness-of-speech-modality-integratio.html" onclick="toggleFavorite(this, '2512.16378v1', 'Hearing to Translate: The Effectiveness of Speech Modality Integration into LLMs')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>5</td>
...
<tr>
  <td>10</td>
  <td><a href="./papers/251216229v1-lopa-scaling-dllm-inference-via-lookahead-parallel-decoding.html">LoPA: Scaling dLLM Inference via Lookahead Parallel Decoding</a></td>
  <td>LoPA：通过前瞻并行解码加速扩散大语言模型推理</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16229v1" data-paper-url="./papers/251216229v1-lopa-scaling-dllm-inference-via-lookahead-parallel-decoding.html" onclick="toggleFavorite(this, '2512.16229v1', 'LoPA: Scaling dLLM Inference via Lookahead Parallel Decoding')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  <td>12</td>
  <td><a href="./papers/251216649v1-justrl-scaling-a-15b-llm-with-a-simple-rl-recipe.html">JustRL: Scaling a 1.5B LLM with a Simple RL Recipe</a></td>
  <td>JustRL：通过简单强化学习方法扩展15亿参数LLM，实现数学推理SOTA</td>
  <td class="tags-cell"><span class="paper-tag">reinforcement learning</span> <span class="paper-tag">curriculum learning</span> <span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16649v1" data-paper-url="./papers/251216649v1-justrl-scaling-a-15b-llm-with-a-simple-rl-recipe.html" onclick="toggleFavorite(this, '2512.16649v1', 'JustRL: Scaling a 1.5B LLM with a Simple RL Recipe')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>

...
2. 提出Multimodal RewardBench 2 (MMRB2)，一个全面的多模态奖励模型评估基准，包含四个具有挑战性的任务。
3. 实验表明，即使是强大的模型如Gemini 3 Pro，在MMRB2上的表现仍与人类专家存在差距，开源模型Qwen3-VL-32B表现接近Gemini 2.5 Flash。

...
**arXiv**: [2511.21533v1](https://arxiv.org/abs/2511.21533) | [PDF](https://arxiv.org/pdf/2511.21533.pdf)
...
**提出孟加拉手语数据集IsharaKhobor以解决低资源翻译问题**

**关键词**: `孟加拉手语翻译` `数据集创建` `基准测试` `低资源语言` `手语识别`

## 📋 核心要点

1. 核心问题：孟加拉手语翻译因资源稀缺而受限，影响听障人士辅助工具开发
2. 方法要点：创建基准数据集，并基于地标和RQE嵌入进行基准测试
3. 实验或效果：通过词汇限制和规范化生成子集，数据集已公开可用

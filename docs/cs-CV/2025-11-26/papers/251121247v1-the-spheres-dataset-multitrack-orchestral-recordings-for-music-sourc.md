...
**arXiv**: [2511.21247v1](https://arxiv.org/abs/2511.21247) | [PDF](https://arxiv.org/pdf/2511.21247.pdf)
...
**提出Spheres数据集以支持古典音乐源分离与信息检索研究**

**关键词**: `音乐源分离` `多轨录音` `管弦乐数据集` `信息检索` `房间脉冲响应` `基准评估`

## 📋 核心要点

1. 核心问题：古典音乐中复杂管弦乐源分离与信息检索的基准数据缺乏
2. 方法要点：使用23个麦克风录制多轨管弦乐，提供隔离音轨和房间脉冲响应
3. 实验或效果：基于X-UMX模型评估，展示源分离潜力与挑战

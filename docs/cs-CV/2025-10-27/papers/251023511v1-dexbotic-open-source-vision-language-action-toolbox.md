...
**提出开源视觉-语言-动作工具箱Dexbotic，支持多策略VLA研究。**

**关键词**: `视觉-语言-动作模型` `开源工具箱` `具身智能` `PyTorch框架` `预训练模型` `实验脚本`

## 📋 核心要点

1. 核心问题：为具身智能领域提供一站式VLA研究服务。
2. 方法要点：基于PyTorch，支持多主流VLA策略，简化环境设置。
3. 实验或效果：提供更强预训练模型，提升SOTA VLA策略性能。

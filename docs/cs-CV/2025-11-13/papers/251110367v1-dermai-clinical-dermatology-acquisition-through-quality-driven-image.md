...
**arXiv**: [2511.10367v1](https://arxiv.org/abs/2511.10367) | [PDF](https://arxiv.org/pdf/2511.10367.pdf)
...
**提出DermAI移动应用以解决皮肤病变AI分类中的数据偏见与质量不均问题**

**关键词**: `皮肤病学AI` `移动图像采集` `数据质量检查` `本地模型适应` `多样化数据集`

## 📋 核心要点

1. 核心问题：AI皮肤病学受限于数据集偏见、图像质量不一和验证不足
2. 方法要点：轻量级移动应用实现实时捕获、标注、质量检查和本地模型适应
3. 实验或效果：公共数据集模型泛化失败，本地数据微调提升性能

...
**arXiv**: [2510.20193v1](https://arxiv.org/abs/2510.20193) | [PDF](https://arxiv.org/pdf/2510.20193.pdf)
...
**综述多媒体检索与跨模态推理架构，以增强问答系统处理图像、音频和视频的能力**

**关键词**: `多媒体问答` `跨模态检索` `模态融合` `问答系统` `基准评估` `语义接地`

## 📋 核心要点

1. 核心问题：传统问答系统依赖文本数据，难以处理多媒体内容带来的跨模态对齐和语义接地挑战
2. 方法要点：分类检索方法、融合技术和答案生成策略，分析视觉、语言和音频模态的对齐架构
3. 实验或效果：评估基准数据集和协议，揭示延迟-准确性权衡，并指出未来研究方向

...
**arXiv**: [2510.20407v1](https://arxiv.org/abs/2510.20407) | [PDF](https://arxiv.org/pdf/2510.20407.pdf)
...
**提出混合现实水下机器人臂遥操作系统，通过双边控制集成视觉与触觉反馈。**

**关键词**: `混合现实` `水下机器人` `双边控制` `触觉反馈` `遥操作` `扭矩指示`

## 📋 核心要点

1. 核心问题：水下机器人臂遥操作中缺乏直观的视觉反馈，影响扭矩控制精度。
2. 方法要点：使用混合现实头显叠加颜色和长度编码的扭矩条，提供实时反应扭矩指示。
3. 实验或效果：用户研究表明，系统显著提高抓取扭矩控制精度，并改善主观可用性。

...
**提出OnlineSplatter以解决无姿态单目视频中自由移动物体的在线3D重建问题**

**关键词**: `在线3D重建` `自由移动物体` `高斯表示` `无姿态重建` `记忆模块` `单目视频`

## 📋 核心要点

1. 核心问题：自由移动物体在无可靠相机姿态或深度先验下的单目视频3D重建挑战
2. 方法要点：使用双键记忆模块融合特征，通过锚定首帧和渐进优化实现高效在线重建
3. 实验或效果：在真实数据集上优于现有方法，计算成本恒定且随观察增加性能提升

...
**arXiv**: [2512.05475v1](https://arxiv.org/abs/2512.05475) | [PDF](https://arxiv.org/pdf/2512.05475.pdf)
...
**比较量子机器学习模型在分子几何学习中的性能，揭示图嵌入提升可训练性**

**关键词**: `量子机器学习` `分子几何学习` `等变性神经网络` `图嵌入` `泛化性评估`

## 📋 核心要点

1. 核心问题：量子机器学习模型在分子几何学习中的性能差异与泛化性评估
2. 方法要点：对比无对称性、旋转和置换等变性及图嵌入置换等变性模型
3. 实验或效果：使用LiH和NH3分子数据集，图嵌入置换等变性模型表现最佳泛化性

...
**arXiv**: [2510.15240v1](https://arxiv.org/abs/2510.15240) | [PDF](https://arxiv.org/pdf/2510.15240.pdf)
...
**分析文本到图像模型在广告中的偏见，并生成文化感知广告以提升针对性。**

**关键词**: `文本到图像模型` `广告偏见分析` `文化感知生成` `说服力评估` `人口统计偏见`

## 📋 核心要点

1. 核心问题：文本到图像模型在广告定制中存在人口统计偏见和说服力差异。
2. 方法要点：通过比较不同性别/种族广告的模型评估，分析偏见和说服力。
3. 实验或效果：开发技术针对特定国家生成广告，代码已开源供验证。

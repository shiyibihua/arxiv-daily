...
**arXiv**: [2510.18608v1](https://arxiv.org/abs/2510.18608) | [PDF](https://arxiv.org/pdf/2510.18608.pdf)
...
**提出组合性与持续学习范式以提升基础模型在动态场景中的适应性**

**关键词**: `基础模型` `持续学习` `组合性` `机器人控制` `多模态学习`

## 📋 核心要点

1. 基础模型在动态真实场景中适应困难，需避免全模型重训练
2. 结合组合性与持续学习原则，增强模型灵活性与效率
3. 未知具体实验效果，但旨在开发更智能的AI解决方案

...
**提出事件接地图以连接空间特征与动态事件，提升机器人场景理解。**

**关键词**: `机器人场景理解` `事件接地图` `时空图表示` `语义场景表示` `自主机器人`

## 📋 核心要点

1. 核心问题：现有语义场景表示缺乏空间特征与动态事件的连接。
2. 方法要点：构建事件接地图框架，将事件交互接地到场景空间特征。
3. 实验或效果：使用真实机器人数据验证，能准确响应复杂时空查询。

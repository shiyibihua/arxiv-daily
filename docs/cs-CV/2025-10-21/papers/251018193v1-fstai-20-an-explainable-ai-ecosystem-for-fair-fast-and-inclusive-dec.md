...
**arXiv**: [2510.18193v1](https://arxiv.org/abs/2510.18193) | [PDF](https://arxiv.org/pdf/2510.18193.pdf)
...
**提出FST.ai 2.0可解释AI生态系统，以支持跆拳道公平快速决策**

**关键词**: `姿态动作识别` `图卷积网络` `可解释AI` `不确定性建模` `实时决策支持` `体育公平性`

## 📋 核心要点

1. 核心问题：奥运和残奥跆拳道中公平透明决策的挑战
2. 方法要点：集成姿态动作识别、不确定性建模和可解释性覆盖
3. 实验或效果：决策审查时间减少85%，裁判信任度达93%

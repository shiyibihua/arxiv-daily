---
layout: default
title: Unconscious and Intentional Human Motion Cues for Expressive Robot-Arm Motion Design
---

# Unconscious and Intentional Human Motion Cues for Expressive Robot-Arm Motion Design

**arXiv**: [2511.03676v1](https://arxiv.org/abs/2511.03676) | [PDF](https://arxiv.org/pdf/2511.03676.pdf)
...
**基于人类运动线索设计机器人手臂表达性运动，分析无意识与意图性行为**

**关键词**: `机器人运动设计` `人类运动分析` `表达性机器人` `物理体现` `运动时机`

## 📋 核心要点

1. 核心问题：如何利用人类运动线索设计机器人手臂的表达性运动。
2. 方法要点：分析游戏中的自然和指令运动，调整速度和停止时长生成机器人运动。
3. 实验或效果：评估物理与视频呈现，发现晚期运动时机和物理体现增强印象形成。

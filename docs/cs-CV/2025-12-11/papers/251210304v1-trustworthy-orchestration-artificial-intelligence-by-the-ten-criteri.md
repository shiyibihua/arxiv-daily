...
**arXiv**: [2512.10304v1](https://arxiv.org/abs/2512.10304) | [PDF](https://arxiv.org/pdf/2512.10304.pdf)
...
**提出基于十准则的可信编排AI框架，通过控制平面治理解决AI系统问责差距问题**

**关键词**: `可信AI` `编排AI` `控制平面治理` `AI问责` `语义一致性` `审计溯源`

## 📋 核心要点

1. 核心问题：AI系统决策能力与制度问责间存在差距，仅靠伦理指导不足
2. 方法要点：集成十准则，将治理嵌入生态系统执行结构，确保可验证、透明、可重现和人类控制
3. 实验或效果：借鉴国际标准和澳大利亚国家AI保证框架，展示可信度可系统化工程实现

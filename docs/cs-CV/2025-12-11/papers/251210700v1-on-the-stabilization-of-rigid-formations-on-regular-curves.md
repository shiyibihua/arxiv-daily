...
**提出随机多启动牛顿类算法和连续反馈律，以稳定多智能体刚性编队在平面曲线上的形成**

**关键词**: `多智能体系统` `刚性编队控制` `曲线稳定` `牛顿类算法` `连续反馈律` `路径扫描`

## 📋 核心要点

1. 核心问题：稳定多智能体刚性编队在平面可微曲线上的形成，包括路径扫描和顶点收敛
2. 方法要点：使用随机多启动牛顿类算法寻找内接正多边形，设计连续反馈律确保曲线扫描和智能体间避碰
3. 实验或效果：通过数值模拟验证方法在不同曲线和刚性编队上的有效性，代码已开源

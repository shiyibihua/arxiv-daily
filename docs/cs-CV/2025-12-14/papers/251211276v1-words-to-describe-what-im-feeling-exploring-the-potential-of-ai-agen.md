...
**arXiv**: [2512.11276v1](https://arxiv.org/abs/2512.11276) | [PDF](https://arxiv.org/pdf/2512.11276.pdf)
...
**提出AI代理作为个人倡导者，以支持高风险高主观性的预先护理规划决策。**

**关键词**: `AI代理` `预先护理规划` `高主观性决策` `经验原型` `设计建议`

## 📋 核心要点

1. 核心问题：严重疾病患者可能失去表达能力，需在预先护理规划中处理高风险高主观性决策。
2. 方法要点：构建经验原型，通过工作坊让参与者训练AI代理作为个人代理，分析应对策略和功能需求。
3. 实验或效果：研究发现AI代理可随时间建立相互理解，提出设计建议以平衡风险与益处。

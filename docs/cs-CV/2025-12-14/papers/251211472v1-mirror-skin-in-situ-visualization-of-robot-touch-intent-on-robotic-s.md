...
**arXiv**: [2512.11472v1](https://arxiv.org/abs/2512.11472) | [PDF](https://arxiv.org/pdf/2512.11472.pdf)
...
**提出Mirror Skin以通过机器人皮肤上的高分辨率视觉反馈增强人机触摸意图的沟通**

**关键词**: `机器人皮肤` `视觉反馈` `人机交互` `触摸意图` `原位可视化`

## 📋 核心要点

1. 核心问题：现有机器人触摸意图沟通方法缺乏空间特异性和语义深度，影响人机交互的安全性和可预测性。
2. 方法要点：采用头足类动物启发的概念，在机器人皮肤上映射人体部位的视觉表示，以原位显示谁、哪里、何时进行触摸。
3. 实验或效果：通过专家设计探索和用户研究，Mirror Skin显著提高了意图解释的准确性和减少了响应时间。

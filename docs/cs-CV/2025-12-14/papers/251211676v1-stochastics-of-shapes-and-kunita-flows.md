...
**arXiv**: [2512.11676v1](https://arxiv.org/abs/2512.11676) | [PDF](https://arxiv.org/pdf/2512.11676.pdf)
...
**提出基于Kunita流的随机形状过程，以支持进化生物学等领域的统计推断**

**关键词**: `随机形状过程` `Kunita流` `形状空间` `统计推断` `桥采样`

## 📋 核心要点

1. 核心问题：形状空间非线性且无限维，构建兼容结构的随机形状过程困难
2. 方法要点：定义理想属性，链接Kunita流以自动满足这些标准
3. 实验或效果：结合桥采样技术，基于观测数据条件化过程，实现参数推断

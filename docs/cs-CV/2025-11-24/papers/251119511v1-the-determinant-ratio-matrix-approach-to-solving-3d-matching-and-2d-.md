...
<div class="paper-toolbar">
  ...
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19511v1" 
            onclick="toggleFavorite(this, '2511.19511v1', 'The Determinant Ratio Matrix Approach to Solving 3D Matching and 2D Orthographic Projection Alignment Tasks')" title="收藏">
      ☆ 收藏
    </button>

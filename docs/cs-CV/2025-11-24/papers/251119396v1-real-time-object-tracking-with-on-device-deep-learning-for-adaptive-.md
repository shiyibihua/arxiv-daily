...
**提出嵌入式系统集成深度学习跟踪与波束成形，实现动态环境中声源精确定位与定向音频捕获。**

**关键词**: `实时目标跟踪` `声学波束成形` `嵌入式深度学习` `3D声源定位` `动态环境适应`

## 📋 核心要点

1. 核心问题：动态声学环境中多源或移动声源的精确跟踪与定向音频捕获。
2. 方法要点：结合单相机深度估计与立体视觉，使用平面同心圆麦克风阵列进行实时波束转向。
3. 实验或效果：实验评估显示信干比显著提升，适用于视频会议和智能家居。

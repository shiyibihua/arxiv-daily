...
**arXiv**: [2511.19180v1](https://arxiv.org/abs/2511.19180) | [PDF](https://arxiv.org/pdf/2511.19180.pdf)
...
**比较PRNU、JPEG压缩和CNN在源相机识别中的设备分类准确率**

**关键词**: `源相机识别` `PRNU` `JPEG压缩伪影` `卷积神经网络` `设备分类` `计算机视觉`

## 📋 核心要点

1. 核心问题：识别图像拍摄设备以支持图像深度分析
2. 方法要点：评估PRNU、JPEG压缩伪影分析和CNN三种技术
3. 实验或效果：比较各方法的设备分类准确率，讨论实际应用需求

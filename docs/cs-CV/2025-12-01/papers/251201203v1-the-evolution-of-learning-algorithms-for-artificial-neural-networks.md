...
**arXiv**: [2512.01203v1](https://arxiv.org/abs/2512.01203) | [PDF](https://arxiv.org/pdf/2512.01203.pdf)
...
**通过遗传算法演化局部学习规则，以探索神经网络学习行为的分布式特性**

**关键词**: `神经网络学习规则` `遗传算法演化` `布尔函数学习` `分布式学习行为` `局部学习规则`

## 📋 核心要点

1. 核心问题：局部学习规则是否足以支持神经网络学习布尔函数
2. 方法要点：遗传编码网络架构与学习动态，施加选择压力演化学习能力
3. 实验或效果：成功演化出网络，分析显示学习行为作为整体网络的分布式属性

...
**提出基于变分方法和曲率依赖能量的曲线提取方法，用于图像中曲线和1D结构的自动提取。**

**关键词**: `曲线提取` `变分方法` `曲率依赖能量` `图像处理` `无监督学习` `子黎曼几何`

## 📋 核心要点

1. 核心问题：从图像中自动提取曲线和1D结构，涉及端点选择和曲率建模。
2. 方法要点：基于能量离散化和向量场分解定理，设计双层最小化变分方法，并扩展到曲率依赖能量。
3. 实验或效果：方法主要为无监督，通过子黎曼或芬斯勒度量在位置和方向空间中提升曲线表示。

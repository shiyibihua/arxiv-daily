...
**arXiv**: [2512.01863v1](https://arxiv.org/abs/2512.01863) | [PDF](https://arxiv.org/pdf/2512.01863.pdf)
...
**提出基于注意力的深度神经网络变分波函数，通过能量最小化发现分数陈绝缘体基态。**

**关键词**: `拓扑序` `深度神经网络变分蒙特卡洛` `分数陈绝缘体` `注意力机制` `强关联系统`

## 📋 核心要点

1. 核心问题：拓扑序强耦合态难以用传统平均场方法研究，理论分析挑战大。
2. 方法要点：利用注意力机制构建变分波函数，无需先验知识，通过能量最小化优化。
3. 实验或效果：从单个实空间波函数分解动量扇区，高效提取拓扑简并度，验证准确性。

...
**arXiv**: [2510.27667v1](https://arxiv.org/abs/2510.27667) | [PDF](https://arxiv.org/pdf/2510.27667.pdf)
...
**提出无监督深度学习去噪框架以提升操作材料显微镜的定量分析能力**

**关键词**: `深度学习去噪` `操作显微镜` `定量分析` `无监督学习` `材料科学` `噪声降低`

## 📋 核心要点

1. 操作显微镜中测量噪声限制有效分辨率和定量分析。
2. 集成无监督深度学习去噪，保持物理保真度并减少模型学习不确定性。
3. 应用于多种实验，揭示纳米级异质性并降低噪声变异性近80%。

## 📄 摘要（原文）

> Operando microscopy provides direct insight into the dynamic chemical and

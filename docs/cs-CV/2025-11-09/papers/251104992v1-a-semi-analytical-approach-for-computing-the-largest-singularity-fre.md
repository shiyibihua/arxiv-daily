...
**arXiv**: [2511.04992v1](https://arxiv.org/abs/2511.04992) | [PDF](https://arxiv.org/pdf/2511.04992.pdf)
...
**提出半解析方法计算6-6 Stewart-Gough平台在指定方向工作空间中的最大无奇点球体**

**关键词**: `Stewart-Gough平台` `无奇点球体` `方向工作空间` `半解析方法` `机器人奇异性分析`

## 📋 核心要点

1. 核心问题：计算6-6 Stewart-Gough平台在指定方向工作空间中的最大无奇点球体
2. 方法要点：固定移动平台方向，解析计算无奇点球体，采样后取最小值
3. 实验或效果：对四种架构进行数值实验，比较无奇点球体体积性能

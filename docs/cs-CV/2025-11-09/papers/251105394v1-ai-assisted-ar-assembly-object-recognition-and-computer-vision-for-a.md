...
**arXiv**: [2511.05394v1](https://arxiv.org/abs/2511.05394) | [PDF](https://arxiv.org/pdf/2511.05394.pdf)
...
**提出基于深度学习的物体识别AR装配系统，以消除手动搜索需求。**

**关键词**: `增强现实装配` `物体识别` `深度学习` `实时定位` `边界框显示`

## 📋 核心要点

1. 核心问题：装配过程中需手动搜索和分类组件，效率低下。
2. 方法要点：使用深度学习识别组件，实时显示边界框和放置位置。
3. 实验或效果：以乐高雕塑装配为例，验证系统可行性。

## 📄 摘要（原文）

> We present an AI-assisted Augmented Reality assembly workflow that uses deep

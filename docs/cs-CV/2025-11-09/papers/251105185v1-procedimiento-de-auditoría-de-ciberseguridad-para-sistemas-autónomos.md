...
**arXiv**: [2511.05185v1](https://arxiv.org/abs/2511.05185) | [PDF](https://arxiv.org/pdf/2511.05185.pdf)
...
**提出自主系统网络安全审计方法，包括分层方法、威胁分类和缓解措施。**

**关键词**: `自主系统安全` `网络安全审计` `威胁分类` `缓解措施` `机器人平台` `案例研究`

## 📋 核心要点

1. 自主系统部署增长带来安全风险，尤其在人类交互环境中。
2. 基于分层方法、威胁分类和缓解措施，设计特定审计程序。
3. 通过四个机器人平台案例研究验证方法有效性。

...
**arXiv**: [2512.08257v1](https://arxiv.org/abs/2512.08257) | [PDF](https://arxiv.org/pdf/2512.08257.pdf)
...
**提出几何-随机多模态深度学习框架，用于预测SUDEP和卒中易感性。**

**关键词**: `多模态深度学习` `几何-随机建模` `SUDEP预测` `卒中易感性` `黎曼流形` `分数随机动力学`

## 📋 核心要点

1. 核心问题：SUDEP和急性缺血性卒中涉及皮质、脑干和自主神经系统的复杂交互，需要多模态建模。
2. 方法要点：结合黎曼流形嵌入、李群不变特征、分数随机动力学、哈密顿能量流建模和跨模态注意力机制。
3. 实验或效果：在MULTI-CLARID数据集上验证，提升预测准确性，并提取可解释的生物标志物。

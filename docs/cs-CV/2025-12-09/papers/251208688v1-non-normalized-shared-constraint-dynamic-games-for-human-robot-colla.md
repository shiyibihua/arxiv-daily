...
**arXiv**: [2512.08688v1](https://arxiv.org/abs/2512.08688) | [PDF](https://arxiv.org/pdf/2512.08688.pdf)
...
**提出非归一化共享约束动态博弈方法，用于人机协作导航中不对称责任的安全约束执行。**

**关键词**: `人机协作` `动态博弈` `共享约束` `非归一化均衡` `滚动时域控制` `安全导航`

## 📋 核心要点

1. 核心问题：人机协作导航中，如何在共享工作空间内处理障碍物，并允许双方以不同努力水平满足安全约束。
2. 方法要点：引入非归一化均衡结构，嵌入滚动时域最优控制方案，实现不对称责任下的共享约束动态博弈。
3. 实验或效果：未知。

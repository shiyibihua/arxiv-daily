...
**arXiv**: [2512.09804v1](https://arxiv.org/abs/2512.09804) | [PDF](https://arxiv.org/pdf/2512.09804.pdf)
...
**提出OnCoCo 1.0公开数据集，用于在线心理咨询对话的细粒度消息分类。**

**关键词**: `在线心理咨询` `细粒度分类` `对话分析` `公开数据集` `心理健康对话`

## 📋 核心要点

1. 核心问题：现有基于动机访谈的分类系统在在线心理咨询中受限，依赖面对面数据，难以详细分析文本对话。
2. 方法要点：开发包含38类咨询师和28类客户话语的新编码方案，构建约2,800条消息的标注数据集。
3. 实验或效果：微调多个模型验证数据集适用性，数据和模型公开可用，扩展心理健康对话分析资源。

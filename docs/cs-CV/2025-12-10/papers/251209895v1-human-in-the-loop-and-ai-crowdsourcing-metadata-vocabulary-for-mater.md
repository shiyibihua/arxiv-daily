...
**arXiv**: [2512.09895v1](https://arxiv.org/abs/2512.09895) | [PDF](https://arxiv.org/pdf/2512.09895.pdf)
...
**提出MatSci-YAMZ平台，集成AI与人机协同以支持材料科学元数据词汇开发**

**关键词**: `元数据词汇开发` `人机协同` `人工智能` `材料科学` `众包` `FAIR原则`

## 📋 核心要点

1. 核心问题：元数据词汇开发受限于人力资源不足和标准化实践不一致，阻碍FAIR和FARR原则推进
2. 方法要点：结合人工智能与人机协同，包括众包，通过迭代反馈循环精炼AI生成的术语定义
3. 实验或效果：在材料科学领域进行概念验证，6名参与者贡献定义，成功生成19个AI定义，证实模型可行性

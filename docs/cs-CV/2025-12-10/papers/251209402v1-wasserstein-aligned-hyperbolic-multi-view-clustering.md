...
**提出Wasserstein对齐双曲多视图聚类框架以解决多视图数据全局语义一致性问题**

**关键词**: `多视图聚类` `双曲表示` `Wasserstein距离` `语义对齐` `Lorentz流形` `全局一致性`

## 📋 核心要点

1. 多视图聚类中现有双曲表示方法忽视全局语义一致性，易受视图特定信息干扰
2. 利用视图特定双曲编码器嵌入Lorentz流形，引入双曲切片Wasserstein距离对齐跨视图分布
3. 在多个基准数据集上实现最先进的聚类性能，验证了方法的有效性

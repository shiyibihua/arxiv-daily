...
**提出基于多智能体强化学习的无人机群分散控制模型，用于关键数据一次性传递**

**关键词**: `多智能体强化学习` `无人机群控制` `分散控制` `扩展性研究` `确定性游戏`

## 📋 核心要点

1. 研究多智能体强化学习在无人机群分散控制中的应用，以传递关键数据包至已知位置
2. 引入确定性游戏家族，设计用于多智能体强化学习的扩展性研究
3. 实验显示，现有多智能体强化学习算法在小规模智能体下表现良好，但扩展性随智能体数量增加而受限

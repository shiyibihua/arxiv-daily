...
**arXiv**: [2512.09570v1](https://arxiv.org/abs/2512.09570) | [PDF](https://arxiv.org/pdf/2512.09570.pdf)
...
**分析国际AI治理框架中的性别问题，强调交叉性、可执行性和包容性以促进公平**

**关键词**: `AI治理` `性别平等` `交叉性` `国际法规` `伦理AI` `包容性设计`

## 📋 核心要点

1. 核心问题：国际AI治理框架如何应对性别议题和性别相关危害，存在不一致、交叉性不足和执行机制薄弱等缺口
2. 方法要点：分析欧盟AI法案、UNESCO AI伦理建议和GPAI等法规与倡议，揭示性别整合趋势和关键挑战
3. 实验或效果：提出有效AI治理需具备交叉性、可执行性和包容性，以超越象征性措施，推动实质公平

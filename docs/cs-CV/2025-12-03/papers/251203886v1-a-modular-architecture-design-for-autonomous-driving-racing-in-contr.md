...
**arXiv**: [2512.03886v1](https://arxiv.org/abs/2512.03886) | [PDF](https://arxiv.org/pdf/2512.03886.pdf)
...
**提出模块化架构设计，用于封闭赛道环境下的自动驾驶赛车系统。**

**关键词**: `自动驾驶赛车` `模块化架构` `计算机视觉` `路径规划` `实时导航`

## 📋 核心要点

1. 核心问题：在封闭赛道中实现高精度自动驾驶，需整合感知、定位、规划与控制。
2. 方法要点：采用模块化设计，各子系统独立运行并通过管道架构连接数据。
3. 实验或效果：结合先进技术，实现受控环境下的实时自主导航。

...
**arXiv**: [2512.03584v1](https://arxiv.org/abs/2512.03584) | [PDF](https://arxiv.org/pdf/2512.03584.pdf)
...
**提出VesselEdge系统，结合联邦学习与轨迹压缩以增强海上AIS覆盖和态势感知。**

**关键词**: `联邦学习` `轨迹压缩` `AIS覆盖增强` `海上态势感知` `异常检测` `低带宽传输`

## 📋 核心要点

1. 核心问题：海上AIS覆盖不足，影响实时态势感知与异常检测。
2. 方法要点：利用联邦学习模型M3fed和带宽约束轨迹压缩算法BWC-DR-A，优先传输异常数据。
3. 实验或效果：初步结果显示VesselEdge能有效提升AIS覆盖，基于历史数据验证系统性能。

...
**arXiv**: [2511.14624v1](https://arxiv.org/abs/2511.14624) | [PDF](https://arxiv.org/pdf/2511.14624.pdf)
...
**提出活性物质框架以解决仿生机器人集体效率与协调问题**

**关键词**: `机器人物理` `活性物质` `群体机器人` `仿生系统` `协调控制`

## 📋 核心要点

1. 核心问题：机器人个体运动与集体协调、通信及成本效率不足
2. 方法要点：融合活性物质物理和生物学原理建模机器人群体
3. 实验或效果：未知，本文为视角文章，未报告具体实验

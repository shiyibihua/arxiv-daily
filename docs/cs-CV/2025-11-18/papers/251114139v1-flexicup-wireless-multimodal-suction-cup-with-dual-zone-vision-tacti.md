...
**提出FlexiCup无线多模态吸盘，集成双区视觉触觉传感以解决非结构化环境中的接触感知操作问题。**

**关键词**: `无线吸盘` `多模态传感` `接触感知操作` `双区视觉触觉` `模块化机械` `端到端学习`

## 📋 核心要点

1. 传统吸盘缺乏传感能力，难以在非结构化环境中实现接触感知操作。
2. FlexiCup通过中央区动态切换视觉与触觉模态，外围区提供空间感知，支持真空和伯努利吸力模式。
3. 实验显示真空模式平均成功率90.0%，伯努利模式86.7%，扩散学习在倾斜运输任务中达73.3%成功率。

...
**arXiv**: [2511.14358v1](https://arxiv.org/abs/2511.14358) | [PDF](https://arxiv.org/pdf/2511.14358.pdf)
...
**提出反向传播算法以识别有限时域线性二次高斯博弈中的时变成本参数**

**关键词**: `博弈论` `成本识别` `线性二次高斯` `反向传播算法` `纳什均衡` `时变参数`

## 📋 核心要点

1. 核心问题：在有限时域线性二次高斯博弈中，从给定纳什均衡策略识别成本参数
2. 方法要点：使用反向传播算法识别时变成本参数，并推导有限轨迹下的概率误差界
3. 实验或效果：在数值和驾驶模拟中测试，算法能重现纳什均衡策略和轨迹观测

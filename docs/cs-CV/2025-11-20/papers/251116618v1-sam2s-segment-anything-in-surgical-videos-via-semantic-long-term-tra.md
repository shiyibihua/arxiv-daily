...
**提出SAM2S模型以解决手术视频中长时跟踪与语义分割的挑战**

**关键词**: `手术视频分割` `长时跟踪` `交互式分割` `语义学习` `基准数据集` `实时推理`

## 📋 核心要点

1. 核心问题：手术视频分割存在领域差异和长时跟踪不足，影响交互式分割模型性能。
2. 方法要点：引入DiveMem机制、时间语义学习和抗模糊学习，增强SAM2的鲁棒性。
3. 实验或效果：在SA-SV基准上，SAM2S达到80.42平均J&F，优于基线并保持实时推理。

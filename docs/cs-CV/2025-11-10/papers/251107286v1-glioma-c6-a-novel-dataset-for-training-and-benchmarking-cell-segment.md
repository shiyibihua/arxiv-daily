...
**提出Glioma C6数据集以支持胶质瘤细胞实例分割的训练与基准测试**

**关键词**: `实例分割` `胶质瘤细胞` `生物医学图像分析` `深度学习基准` `细胞形态分类`

## 📋 核心要点

1. 核心问题：缺乏用于胶质瘤C6细胞实例分割的开放数据集，限制深度学习模型开发。
2. 方法要点：提供75张高分辨率图像和超1.2万个细胞标注，包括体细胞注释和形态分类。
3. 实验或效果：训练模型显著提升分割性能，验证数据集对鲁棒和泛化模型的价值。

...
**arXiv**: [2511.07325v1](https://arxiv.org/abs/2511.07325) | [PDF](https://arxiv.org/pdf/2511.07325.pdf)
...
**提出基于物联网与计算机视觉的智能系统以监控城市垃圾易发点非法倾倒问题**

**关键词**: `垃圾检测` `物体检测` `物联网监控` `城市废物管理` `YOLO模型` `实时监控`

## 📋 核心要点

1. 核心问题：城市垃圾易发点非法倾倒缺乏高效监控，影响市政固体废物管理。
2. 方法要点：结合物联网与计算机视觉，使用街级摄像头和物体检测算法实时检测垃圾。
3. 实验或效果：在印度数据集上评估多种模型，YOLO11m准确率达92.39%，mAP@50为0.91。

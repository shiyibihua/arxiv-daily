...
**提出SafeHumanoid，结合VLM-RAG驱动人形机器人上身阻抗控制以提升人机交互安全性**

**关键词**: `人形机器人控制` `视觉语言模型` `检索增强生成` `阻抗控制` `人机交互安全` `第一人称视觉`

## 📋 核心要点

1. 核心问题：人机交互需机器人根据场景和人类接近度调节阻抗与速度以确保安全
2. 方法要点：利用视觉语言模型和检索增强生成处理第一人称视觉，映射到关节级阻抗命令
3. 实验或效果：在桌面操作任务中自适应刚度和速度，保持任务成功率并提高安全性

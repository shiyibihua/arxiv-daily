...
**arXiv**: [2511.23205v1](https://arxiv.org/abs/2511.23205) | [PDF](https://arxiv.org/pdf/2511.23205.pdf)
...
**提出PLS-Lasso方法，集成降维与回归，应用于金融指数追踪。**

**关键词**: `多元数据分析` `降维回归` `PLS-Lasso` `指数追踪` `优化算法`

## 📋 核心要点

1. 传统多元数据分析中，降维与回归常作为独立步骤处理，如PCR和PLS。
2. 本文提出PLS-Lasso方法，将降维直接融入回归过程，提供两种优化算法。
3. 在金融指数追踪任务中，PLS-Lasso与Lasso相比，展现出有前景的结果。

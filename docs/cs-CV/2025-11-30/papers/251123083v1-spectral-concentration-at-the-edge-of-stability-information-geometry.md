...
**arXiv**: [2511.23083v1](https://arxiv.org/abs/2511.23083) | [PDF](https://arxiv.org/pdf/2511.23083.pdf)
...
**提出基于统计流形的几何理论，解释高容量核Hopfield网络中的优化岭与稳定性边缘现象。**

**关键词**: `核Hopfield网络` `统计流形` `稳定性边缘` `Fisher信息矩阵` `自组织临界性` `最小描述长度`

## 📋 核心要点

1. 核心问题：高容量核Hopfield网络的优化岭现象与谱集中起源不明。
2. 方法要点：在统计流形上分析网络动力学，揭示优化岭对应Fisher信息矩阵奇异的稳定性边缘。
3. 实验或效果：通过黎曼空间中的对偶平衡统一学习动态与容量，基于最小描述长度原理提供自组织临界性的几何理论。

...
**arXiv**: [2511.22994v1](https://arxiv.org/abs/2511.22994) | [PDF](https://arxiv.org/pdf/2511.22994.pdf)
...
**评估AdamW、SGD与RMSprop优化器对基于ViT的虹膜识别准确性与稳定性的影响**

**关键词**: `虹膜识别` `Vision Transformer` `优化器比较` `生物特征认证` `深度学习稳定性`

## 📋 核心要点

1. 核心问题：优化器选择对基于Vision Transformer的虹膜识别系统性能影响未知
2. 方法要点：比较AdamW、SGD和RMSprop优化器在ViT模型中的应用
3. 实验或效果：评估不同优化器对虹膜识别准确性和模型稳定性的影响

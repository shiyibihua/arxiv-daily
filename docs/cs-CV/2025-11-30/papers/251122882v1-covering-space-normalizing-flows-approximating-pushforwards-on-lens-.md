...
**arXiv**: [2511.22882v1](https://arxiv.org/abs/2511.22882) | [PDF](https://arxiv.org/pdf/2511.22882.pdf)
...
**提出覆盖空间归一化流以近似透镜空间上的推前分布，用于建模对称分布。**

**关键词**: `归一化流` `透镜空间` `推前分布` `覆盖映射` `对称分布` `密度估计`

## 📋 核心要点

1. 核心问题：在透镜空间L(p;q)上近似通过通用覆盖映射从S^3推前的分布。
2. 方法要点：利用覆盖映射构建推前分布，通过归一化流在透镜空间上近似，并删除对称S^3分布中的冗余。
3. 实验或效果：近似了von Mises-Fisher诱导的目标密度和苯模型中的Z_12对称玻尔兹曼分布的推前。

...
**提出纹理引导的高斯-网格联合优化框架，以改进多视图重建，支持下游编辑任务。**

**关键词**: `多视图重建` `高斯-网格联合优化` `可微分渲染` `几何正则化` `纹理引导` `3D编辑`

## 📋 核心要点

1. 核心问题：现有方法在几何精度与渲染真实感间权衡，解耦优化阻碍编辑任务。
2. 方法要点：联合优化网格几何与顶点颜色，利用高斯引导的可微分渲染和正则化。
3. 实验或效果：获得高质量3D重建，可应用于重光照和形状变形等编辑任务。

...
**提出多任务框架以提升胃肠道视觉问答的准确性和可解释性**

**关键词**: `多任务学习` `视觉问答` `医学图像分析` `视觉定位` `解释生成` `LoRA微调`

## 📋 核心要点

1. 核心问题：医学视觉问答中视觉推理和解释生成不足
2. 方法要点：使用LoRA微调Florence-2模型，集成多任务学习
3. 实验或效果：多任务学习显著优于单任务基线，提高答案准确性和视觉定位

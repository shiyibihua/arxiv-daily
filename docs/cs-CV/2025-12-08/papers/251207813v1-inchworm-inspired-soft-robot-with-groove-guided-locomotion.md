...
**arXiv**: [2512.07813v1](https://arxiv.org/abs/2512.07813) | [PDF](https://arxiv.org/pdf/2512.07813.pdf)
...
**提出基于沟槽引导的尺蠖仿生软体机器人，以简化复杂地形导航中的方向控制**

**关键词**: `软体机器人` `仿生运动` `被动控制` `介电弹性体执行器` `沟槽引导` `简化设计`

## 📋 核心要点

1. 核心问题：软体机器人方向控制常需多执行器，导致机械复杂、能耗高。
2. 方法要点：使用单卷曲介电弹性体执行器，通过3D打印基板沟槽图案被动引导运动方向。
3. 实验或效果：系统实验表明，改变沟槽角度可实现精确方向控制，降低能耗并简化设计。

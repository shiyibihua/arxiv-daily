...
**提出互补学习方法，利用大语言模型进行成本高效文本分类，解决人机协作中的弱点管理问题。**

**关键词**: `文本分类` `大语言模型` `互补学习` `人机协作` `少样本学习` `溯因推理`

## 📋 核心要点

1. 核心问题：如何在大语言模型应用中，以低成本方式管理其固有弱点，并整合人机优势进行文本分类。
2. 方法要点：采用思维链和少样本学习提示，将定性研究中的合作团队最佳实践扩展到人机团队，支持溯因推理和自然语言交互。
3. 实验或效果：应用于1934份制药联盟新闻稿（1990-2017），演示如何分析人机评分差异，验证方法的实用性。

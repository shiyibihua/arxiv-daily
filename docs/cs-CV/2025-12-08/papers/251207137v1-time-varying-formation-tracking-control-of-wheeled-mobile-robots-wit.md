...
**arXiv**: [2512.07137v1](https://arxiv.org/abs/2512.07137) | [PDF](https://arxiv.org/pdf/2512.07137.pdf)
...
**提出基于广义Udwadia-Kalaba框架的轮式移动机器人时变编队跟踪控制方法，考虑区域约束以确保安全性。**

**关键词**: `轮式移动机器人` `时变编队跟踪` `区域约束` `Udwadia-Kalaba框架` `控制策略`

## 📋 核心要点

1. 研究轮式移动机器人的时变编队跟踪控制问题，引入区域约束以保障机器人安全运行。
2. 采用广义Udwadia-Kalaba框架，将控制目标重构为约束方程，并通过微分同胚变换处理区域约束。
3. 通过数值仿真验证了所提控制策略的有效性，展示了在区域约束下的编队跟踪性能。

...
**提出基于ROS 2的自主赛车软件栈，在CARLA中模拟高速竞速场景。**

**关键词**: `自主竞速` `ROS 2集成` `传感器融合` `轨迹优化` `CARLA模拟`

## 📋 核心要点

1. 核心问题：在高速自主竞速中，感知、规划与控制面临不确定性和动态挑战。
2. 方法要点：使用LiDAR、相机、GNSS和IMU传感器，通过ROS 2实现轨迹优化和边界检测。
3. 实验或效果：在CARLA中验证系统，检测锥桶距离达35米，并移植到实际硬件。

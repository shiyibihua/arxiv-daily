...
**开发数据集生成器和任务规划器，用于家庭服务机器人的个性化辅助。**

**关键词**: `机器人视觉系统` `任务规划` `脑启发记忆模型` `数据集生成` `导航系统` `家庭服务机器人`

## 📋 核心要点

1. 核心问题：家庭服务机器人需适应个体环境并提供直观辅助。
2. 方法要点：使用大语言模型规划任务，并研究脑启发记忆模型。
3. 实验或效果：通过模拟器和竞赛评估系统，提升导航系统可重用性。

...
**arXiv**: [2511.20610v1](https://arxiv.org/abs/2511.20610) | [PDF](https://arxiv.org/pdf/2511.20610.pdf)
...
**基于GPT-2构建轨迹基础模型教程，填补移动性AI实现空白**

**关键词**: `轨迹基础模型` `GPT-2适配` `时空数据处理` `模型比较` `移动性AI` `代码实现教程`

## 📋 核心要点

1. 核心问题：移动性轨迹基础模型从零构建缺乏清晰文档和实现指导。
2. 方法要点：通过代码驱动步骤，将GPT-2适配于时空数据，并比较TrajFM等模型。
3. 实验或效果：未知具体实验效果，但提供实现级概念解释，支持社区模型构建与评估。

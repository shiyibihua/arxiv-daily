...
**提出大型多模态嗅觉数据集以解决自然场景嗅觉数据缺乏问题**

**关键词**: `多模态数据集` `嗅觉表示学习` `跨模态检索` `场景识别` `细粒度分类`

## 📋 核心要点

1. 核心问题：嗅觉作为动物感知世界的重要方式，在机器中难以访问，缺乏自然场景多模态数据。
2. 方法要点：收集7000对图像-嗅觉信号，覆盖3500个对象，室内外环境，数据规模远超现有。
3. 实验或效果：视觉数据支持跨模态嗅觉学习，学习表示优于手工特征，应用于检索和识别任务。

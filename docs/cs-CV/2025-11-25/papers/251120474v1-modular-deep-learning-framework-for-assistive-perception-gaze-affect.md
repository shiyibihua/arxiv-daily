...
**提出模块化深度学习框架，用于辅助感知中的注视、情感和说话人识别。**

**关键词**: `模块化深度学习` `眼状态检测` `面部表情识别` `说话人识别` `辅助技术` `多模态感知`

## 📋 核心要点

1. 核心问题：开发综合辅助技术需整合视觉和听觉感知，适应资源受限设备。
2. 方法要点：采用模块化架构，包括CNN检测眼状态、CNN识别表情和LSTM识别说话人。
3. 实验或效果：在多个数据集上，模型准确率分别达93.0%、97.8%和96.89%。

...
**arXiv**: [2511.20321v1](https://arxiv.org/abs/2511.20321) | [PDF](https://arxiv.org/pdf/2511.20321.pdf)
...
**提出离散状态空间主动推理方法，澄清与自由能原理的关系。**

**关键词**: `主动推理` `离散状态空间` `散度最小化` `平均场方法` `变分自由能`

## 📋 核心要点

1. 核心问题：澄清主动推理与自由能原理的混淆，独立定义推理过程。
2. 方法要点：将推理优化建模为约束散度最小化，使用标准平均场方法求解。
3. 效果：感知时与变分自由能一致，行动时增加熵正则化项。

---
layout: default
title: arXiv 中文要点汇总 - cs.CV - 2025-12-16
---
...
<a href="#支柱三空间感知-perception-slam" class="interest-badge">支柱三：空间感知 (Perception & SLAM) (20 🔗3)</a>
<a href="#支柱九具身大模型-embodied-foundation-models" class="interest-badge">支柱九：具身大模型 (Embodied Foundation Models) (15 🔗4)</a>
<a href="#支柱二rl算法与架构-rl-architecture" class="interest-badge">支柱二：RL算法与架构 (RL & Architecture) (13)</a>
<a href="#支柱三空间感知与语义-perception-semantics" class="interest-badge">支柱三：空间感知与语义 (Perception & Semantics) (11 🔗1)</a>
<a href="#支柱一机器人控制-robot-control" class="interest-badge">支柱一：机器人控制 (Robot Control) (8)</a>
<a href="#支柱四生成式动作-generative-motion" class="interest-badge">支柱四：生成式动作 (Generative Motion) (5)</a>
<a href="#支柱七动作重定向-motion-retargeting" class="interest-badge">支柱七：动作重定向 (Motion Retargeting) (2)</a>
</div>

---


<h2 id="支柱三空间感知-perception-slam">🔬 支柱三：空间感知 (Perception & SLAM) (20 篇)</h2>
...
<tr>
  ...
  <td>提出HGS混合高斯溅射方法，通过静态-动态解耦实现紧凑的动态场景新视角合成。</td>
...
<tr>
  ...
  <td>SkyLume：一个大规模多光照城市重建航拍数据集，用于解决光照变化下的三维重建问题。</td>
...
<tr>
  ...
  <td>DASP：利用时空先验域适应的自监督夜间单目深度估计</td>
  <td class="tags-cell"><span class="paper-tag">depth estimation</span> <span class="paper-tag">monocular depth</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14536v1" onclick="toggleFavorite(this, '2512.14536v1', 'DASP: Self-supervised Nighttime Monocular Depth Estimation with Domain Adaptation of Spatiotemporal Priors')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>6</td>
  ...
  <td>ExpanDyNeRF：扩展动态场景视角合成，解决单目视频大角度渲染失真问题</td>
...
<tr>
  ...
  <td>提出GaussianPlant以解决植物3D重建中的结构与外观分离问题</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">3DGS</span> <span class="paper-tag">gaussian splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14087v1" onclick="toggleFavorite(this, '2512.14087v1', 'GaussianPlant: Structure-aligned Gaussian Splatting for 3D Reconstruction of Plants')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>8</td>
  ...
  <td>ACE-SLAM：基于场景坐标回归的神经隐式实时SLAM系统</td>
  <td class="tags-cell"><span class="paper-tag">SLAM</span> <span class="paper-tag">localization</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14032v1" onclick="toggleFavorite(this, '2512.14032v1', 'ACE-SLAM: Scene Coordinate Regression for Neural Implicit Real-Time SLAM')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>9</td>
  ...
  <td>提出CLNet，通过跨视角对应关系增强图像检索地理定位</td>
  <td class="tags-cell"><span class="paper-tag">localization</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14560v1" onclick="toggleFavorite(this, '2512.14560v1', 'CLNet: Cross-View Correspondence Makes a Stronger Geo-Localizationer')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>10</td>
  ...
  <td>提出UNITE：用于3D场景理解的统一语义Transformer模型</td>
  <td class="tags-cell"><span class="paper-tag">scene understanding</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14364v1" onclick="toggleFavorite(this, '2512.14364v1', 'Unified Semantic Transformer for 3D Scene Understanding')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>11</td>
  ...
  <td>提出4D-RaDiff，利用潜在扩散模型生成4D雷达点云，提升目标检测性能。</td>
  <td class="tags-cell"><span class="paper-tag">point cloud</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14235v1" onclick="toggleFavorite(this, '2512.14235v1', '4D-RaDiff: Latent Diffusion for 4D Radar Point Cloud Generation')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>12</td>
  ...
  <td>提出历史增强型两阶段Transformer，解决无人机视觉语言导航中全局推理与局部理解的平衡问题</td>
  <td class="tags-cell"><span class="paper-tag">navigation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14222v1" onclick="toggleFavorite(this, '2512.14222v1', 'History-Enhanced Two-Stage Transformer for Aerial Vision-and-Language Navigation')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>13</td>
  ...
  <td>提出球面Voronoi方法，用于3D高斯溅射中高效可微的方向外观建模</td>
...
<tr>
  ...
  <td>FastDDHPose：统一、高效、解耦的3D人体姿态估计方法</td>
  <td class="tags-cell"><span class="paper-tag">pose estimation</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14162v1" onclick="toggleFavorite(this, '2512.14162v1', 'FastDDHPose: Towards Unified, Efficient, and Disentangled 3D Human Pose Estimation')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>15</td>
  ...
  <td>提出一致性实例场，用于动态场景理解中的时空一致性分割与查询。</td>
  <td class="tags-cell"><span class="paper-tag">scene understanding</span></td>
  <td></td>
...
<tr>
  ...
  <td>提出基于神经特征解码的鲁棒单目结构光3D成像方法，提升复杂场景下的深度估计精度。</td>
  ...
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14028v1" onclick="toggleFavorite(this, '2512.14028v1', 'Robust Single-shot Structured Light 3D Imaging via Neural Feature Decoding')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>17</td>
  ...
  <td>ASAP-Textured Gaussians：通过自适应采样和各向异性参数化增强纹理高斯模型</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">gaussian splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14039v1" onclick="toggleFavorite(this, '2512.14039v1', 'ASAP-Textured Gaussians: Enhancing Textured Gaussians with Adaptive Sampling and Anisotropic Parameterization')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>18</td>
  ...
  <td>提出TUN网络，利用深度学习自动检测持久同调图中显著特征点。</td>
  <td class="tags-cell"><span class="paper-tag">point cloud</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14274v1" onclick="toggleFavorite(this, '2512.14274v1', 'TUN: Detecting Significant Points in Persistence Diagrams with Deep Learning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>19</td>
  ...
  <td>Zoom-Zero：通过时间域缩放增强视频理解，解决GVQA中时序定位不准问题。</td>
  <td class="tags-cell"><span class="paper-tag">localization</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14273v1" onclick="toggleFavorite(this, '2512.14273v1', 'Zoom-Zero: Reinforced Coarse-to-Fine Video Understanding via Temporal Zoom-in')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>20</td>
  ...
  <td>Elastic3D：基于引导式潜在解码的可控立体视频转换方法</td>
  <td class="tags-cell"><span class="paper-tag">depth estimation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14236v1" onclick="toggleFavorite(this, '2512.14236v1', 'Elastic3D: Controllable Stereo Video Conversion with Guided Latent Decoding')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>


<h2 id="支柱九具身大模型-embodied-foundation-models">🔬 支柱九：具身大模型 (Embodied Foundation Models) (15 篇)</h2>
...
<tr>
  ...
  <td>HyperVL：面向边缘设备的高效动态多模态大语言模型</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14052v1" onclick="toggleFavorite(this, '2512.14052v1', 'HyperVL: An Efficient and Dynamic Multimodal Large Language Model for Edge Devices')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>22</td>
  ...
  <td>提出KEMM模型，利用LLM增强知识的多模态癌症生存预测。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14594v1" onclick="toggleFavorite(this, '2512.14594v1', 'LLM-driven Knowledge Enhancement for Multimodal Cancer Survival Prediction')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>23</td>
...
<tr>
  ...
  <td>ReVision：基于大规模临床实践的视网膜原生智能模型，提升部署效率</td>
  <td class="tags-cell"><span class="paper-tag">foundation model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14499v1" onclick="toggleFavorite(this, '2512.14499v1', 'Native Intelligence Emerges from Large-Scale Clinical Practice: A Retinal Foundation Model with Deployment Efficiency')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>25</td>
...
<tr>
  ...
  <td>OmniGen：提出统一多模态传感器生成框架，用于自动驾驶场景数据增强。</td>
  <td class="tags-cell"><span class="paper-tag">multimodal</span></td>
  <td></td>
...
<tr>
  ...
  <td>提出ChartAgent，一个工具集成推理的图表理解框架，提升稀疏标注下的鲁棒性。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14040v1" onclick="toggleFavorite(this, '2512.14040v1', 'ChartAgent: A Chart Understanding Framework with Tool Integrated Reasoning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>29</td>
  ...
  <td>提出KFS-Bench基准，用于长视频问答中关键帧采样的全面评估。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span> <span class="paper-tag">multimodal</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14017v1" onclick="toggleFavorite(this, '2512.14017v1', 'KFS-Bench: Comprehensive Evaluation of Key Frame Sampling in Long Video Understanding')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>30</td>
  ...
  <td>提出ViRC框架，通过Reason Chunking增强视觉交错数学CoT推理能力</td>
  <td class="tags-cell"><span class="paper-tag">multimodal</span></td>
  <td>✅</td>
...
<tr>
  ...
  <td>提出TorchTraceAP基准数据集，用于检测计算机视觉模型中的性能反模式。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14141v1" onclick="toggleFavorite(this, '2512.14141v1', 'TorchTraceAP: A New Benchmark Dataset for Detecting Performance Anti-Patterns in Computer Vision Models')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>35</td>
  ...
  <td>提出一种免训练免数据的CLIP可控选择性领域无关知识遗忘方法</td>
  <td class="tags-cell"><span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14113v1" onclick="toggleFavorite(this, '2512.14113v1', 'Selective, Controlled and Domain-Agnostic Unlearning in Pretrained CLIP: A Training- and Data-Free Approach')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td>WorldPlay：提出一种具有长期几何一致性的实时交互式世界建模方法。</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14614v1" onclick="toggleFavorite(this, '2512.14614v1', 'WorldPlay: Towards Long-Term Geometric Consistency for Real-Time Interactive World Modeling')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>38</td>
  ...
  <td>提出A4-Agent框架以解决零-shot可供性推理问题</td>
...
<tr>
  ...
  <td>TimeLens：利用多模态LLM重新思考视频时序定位任务，构建高质量基线。</td>
...
<tr>
  ...
  <td>提出S2D：一种稀疏到稠密的Keymask蒸馏方法，用于无监督视频实例分割</td>
  <td class="tags-cell"><span class="paper-tag">distillation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14440v1" onclick="toggleFavorite(this, '2512.14440v1', 'S2D: Sparse-To-Dense Keymask Distillation for Unsupervised Video Instance Segmentation')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>44</td>
  ...
  <td>FacEDiT：通过面部运动填充统一实现说话人脸编辑与生成</td>
  <td class="tags-cell"><span class="paper-tag">flow matching</span> <span class="paper-tag">masked autoencoder</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14056v1" onclick="toggleFavorite(this, '2512.14056v1', 'FacEDiT: Unified Talking Face Editing and Generation via Facial Motion Infilling')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>45</td>
  <td><a href="./papers/251214614v1-worldplay-towards-long-term-geometric-consistency-for-real-time-inte.html">WorldPlay: Towards Long-Term Geometric Consistency for Real-Time Interactive World Modeling</a></td>
...
<tr>
  <td>47</td>
  <td><a href="./papers/251214442v1-a4-agent-an-agentic-framework-for-zero-shot-affordance-reasoning.html">A4-Agent: An Agentic Framework for Zero-Shot Affordance Reasoning</a></td>
  <td>提出A4-Agent：一种用于零样本可供性推理的Agent框架</td>
...
<tr>
  <td>48</td>
  <td><a href="./papers/251214056v1-facedit-unified-talking-face-editing-and-generation-via-facial-motio.html">FacEDiT: Unified Talking Face Editing and Generation via Facial Motion Infilling</a></td>
  <td>FacEDiT：通过面部运动填充实现统一的说话人脸编辑与生成</td>
  <td class="tags-cell"><span class="paper-tag">flow matching</span> <span class="paper-tag">masked autoencoder</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14056v1" onclick="toggleFavorite(this, '2512.14056v1', 'FacEDiT: Unified Talking Face Editing and Generation via Facial Motion Infilling')" title="添加到收藏夹">☆</button></td>
</tr>
...
<h2 id="支柱三空间感知与语义-perception-semantics">🔬 支柱三：空间感知与语义 (Perception & Semantics) (11 篇)</h2>
...
<tr>
  <td>50</td>
  <td><a href="./papers/251214352v1-hgs-hybrid-gaussian-splatting-with-static-dynamic-decomposition-for-.html">HGS: Hybrid Gaussian Splatting with Static-Dynamic Decomposition for Compact Dynamic View Synthesis</a></td>
  <td>提出混合高斯溅射HGS，通过静态-动态分解实现紧凑的动态视角合成</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">3DGS</span> <span class="paper-tag">gaussian splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14352v1" onclick="toggleFavorite(this, '2512.14352v1', 'HGS: Hybrid Gaussian Splatting with Static-Dynamic Decomposition for Compact Dynamic View Synthesis')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>51</td>
  <td><a href="./papers/251214087v1-gaussianplant-structure-aligned-gaussian-splatting-for-3d-reconstruc.html">GaussianPlant: Structure-aligned Gaussian Splatting for 3D Reconstruction of Plants</a></td>
  <td>GaussianPlant：提出结构对齐的高斯溅射方法，用于植物三维重建。</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">3DGS</span> <span class="paper-tag">gaussian splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14087v1" onclick="toggleFavorite(this, '2512.14087v1', 'GaussianPlant: Structure-aligned Gaussian Splatting for 3D Reconstruction of Plants')" title="添加到收藏夹">☆</button></td>
</tr>
...
<tr>
  <td>57</td>
  <td><a href="./papers/251214039v1-asap-textured-gaussians-enhancing-textured-gaussians-with-adaptive-s.html">ASAP-Textured Gaussians: Enhancing Textured Gaussians with Adaptive Sampling and Anisotropic Parameterization</a></td>
  <td>提出自适应采样与各向异性参数化以解决纹理高效性问题</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">gaussian splatting</span> <span class="paper-tag">splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14039v1" onclick="toggleFavorite(this, '2512.14039v1', 'ASAP-Textured Gaussians: Enhancing Textured Gaussians with Adaptive Sampling and Anisotropic Parameterization')" title="添加到收藏夹">☆</button></td>
</tr>
...
<tr>
  ...
  <td>CRISP：基于单目视频和平面场景原语的接触引导Real2Sim方法</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14696v1" onclick="toggleFavorite(this, '2512.14696v1', 'CRISP: Contact-Guided Real2Sim from Monocular Video with Planar Scene Primitives')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>61</td>
...
<tr>
  ...
  <td>提出TDAE框架，增强图像对恶意编辑的防御迁移能力</td>
  <td class="tags-cell"><span class="paper-tag">manipulation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14341v1" onclick="toggleFavorite(this, '2512.14341v1', 'Towards Transferable Defense Against Malicious Image Edits')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>64</td>
  ...
  <td>提出Vector Prism，通过分层语义结构实现矢量图形动画</td>
  <td class="tags-cell"><span class="paper-tag">motion planning</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14336v1" onclick="toggleFavorite(this, '2512.14336v1', 'Vector Prism: Animating Vector Graphics by Stratifying Semantic Structure')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>65</td>
  <td><a href="./papers/251214696v1-crisp-contact-guided-real2sim-from-monocular-video-with-planar-scene.html">CRISP: Contact-Guided Real2Sim from Monocular Video with Planar Scene Primitives</a></td>
...
<tr>
  <td>67</td>
  <td><a href="./papers/251214217v1-draw2act-turning-depth-encoded-trajectories-into-robotic-demonstrati.html">DRAW2ACT: Turning Depth-Encoded Trajectories into Robotic Demonstration Videos</a></td>
  <td>提出DRAW2ACT以解决机器人演示视频生成的可控性问题</td>
  <td class="tags-cell"><span class="paper-tag">manipulation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14217v1" onclick="toggleFavorite(this, '2512.14217v1', 'DRAW2ACT: Turning Depth-Encoded Trajectories into Robotic Demonstration Videos')" title="添加到收藏夹">☆</button></td>
</tr>
...
<h2 id="支柱四生成式动作-generative-motion">🔬 支柱四：生成式动作 (Generative Motion) (5 篇)</h2>
...
<tr>
  ...
  <td>Sparse-LaViDa：通过稀疏化采样加速多模态离散扩散语言模型</td>
  <td class="tags-cell"><span class="paper-tag">MDM</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14008v1" onclick="toggleFavorite(this, '2512.14008v1', 'Sparse-LaViDa: Sparse Multimodal Discrete Diffusion Language Models')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>69</td>
  ...
  <td>ViBES：一种具有行为智能的3D虚拟身体对话代理</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14234v1" onclick="toggleFavorite(this, '2512.14234v1', 'ViBES: A Conversational Agent with Behaviorally-Intelligent 3D Virtual Body')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>70</td>
  ...
  <td>VASA-3D：基于单张图像的逼真音频驱动高斯头部化身生成</td>
  <td class="tags-cell"><span class="paper-tag">motion latent</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14677v1" onclick="toggleFavorite(this, '2512.14677v1', 'VASA-3D: Lifelike Audio-Driven Gaussian Head Avatars from a Single Image')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>71</td>
  <td><a href="./papers/251214234v1-vibes-a-conversational-agent-with-behaviorally-intelligent-3d-virtua.html">ViBES: A Conversational Agent with Behaviorally-Intelligent 3D Virtual Body</a></td>
  <td>ViBES：一种具有行为智能的3D虚拟化身对话代理</td>
...
<tr>
  ...
  <td>ViewMask-1-to-3：基于多模态扩散模型实现多视角一致的图像生成</td>
  <td class="tags-cell"><span class="paper-tag">geometric consistency</span> <span class="paper-tag">multimodal</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14099v1" onclick="toggleFavorite(this, '2512.14099v1', 'ViewMask-1-to-3: Multi-View Consistent Image Generation via Multimodal Diffusion Models')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>74</td>
  ...
  <td>SketchAssist：用于语义编辑和精确局部重绘的实用草图助手</td>
  <td class="tags-cell"><span class="paper-tag">structure preservation</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.14140v1" onclick="toggleFavorite(this, '2512.14140v1', 'SketchAssist: A Practical Assistant for Semantic Edits and Precise Local Redrawing')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>

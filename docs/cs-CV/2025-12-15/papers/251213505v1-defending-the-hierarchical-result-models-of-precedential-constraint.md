...
**arXiv**: [2512.13505v1](https://arxiv.org/abs/2512.13505) | [PDF](https://arxiv.org/pdf/2512.13505.pdf)
...
**为基于结果的层次模型辩护，以应对先例约束中的批评**

**关键词**: `先例约束` `层次模型` `案例推理` `法律推理` `模型辩护`

## 📋 核心要点

1. 核心问题：回应Bench-Capon对层次先例约束模型的批评，特别是中间因素强度差异问题。
2. 方法要点：指出批评可能源于将中间因素误解为维度，应用基于维度的层次模型可避免问题。
3. 实验或效果：通过理论论证，展示van Woerkom的模型在相关示例中能正确应对批评。

...
**提出ModSSC框架以统一异构数据上的半监督分类算法实现与实验配置**

**关键词**: `半监督分类` `异构数据处理` `模块化框架` `开源软件` `实验复现`

## 📋 核心要点

1. 核心问题：现有半监督分类软件支持分散，缺乏统一框架处理异构数据和方法。
2. 方法要点：提供模块化开源Python框架，集成归纳与直推式算法，支持多种数据类型和硬件。
3. 实验或效果：通过YAML声明式实验配置，便于复现和比较研究，已发布1.0.0版本。

...
**提出事件驱动通信框架，集成持续学习以在物联网网络中实现节能故障检测。**

**关键词**: `物联网网络` `故障检测` `持续学习` `节能通信` `轻量级机器学习` `边缘计算`

## 📋 核心要点

1. 核心问题：物联网设备资源受限，环境非平稳导致模型推理精度下降，更新模型能耗高。
2. 方法要点：基于无线链路条件和能量预算，设备与边缘服务器协作更新轻量级机器学习模型。
3. 实验或效果：在真实数据集上，相比周期性采样和非自适应持续学习，推理召回率提升高达42.8%。

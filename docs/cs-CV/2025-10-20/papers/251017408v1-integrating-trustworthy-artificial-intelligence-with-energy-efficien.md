...
**arXiv**: [2510.17408v1](https://arxiv.org/abs/2510.17408) | [PDF](https://arxiv.org/pdf/2510.17408.pdf)
...
**提出可信AI与节能机械臂集成方法以解决城市垃圾智能分类问题**

**关键词**: `可信人工智能` `节能机械臂` `垃圾分类` `卷积神经网络` `迁移学习` `能量优化`

## 📋 核心要点

1. 核心问题：城市垃圾智能分类需高精度、节能且可信赖的自动化系统。
2. 方法要点：使用MobileNetV2增强CNN进行迁移学习，实现六类垃圾准确分类。
3. 实验或效果：模型训练准确率99.8%，验证准确率80.5%；虚拟仿真优化能耗。

## 📄 摘要（原文）

> This paper presents a novel methodology that integrates trustworthy

...
**报告AIM 2025高效真实世界单图像去模糊挑战，评估方法在效率约束下的性能**

**关键词**: `图像去模糊` `效率约束` `真实世界图像` `PSNR评估` `挑战报告`

## 📋 核心要点

1. 核心问题：在真实世界图像中高效去模糊，需满足参数少于500万和计算量低于200 GMACs
2. 方法要点：基于RSBlur数据集，使用双相机系统捕获模糊与退化图像对进行方法开发
3. 实验或效果：最佳方法PSNR达31.1298 dB，4个团队提交有效方案，展示高效去模糊潜力

...
**arXiv**: [2510.25255v1](https://arxiv.org/abs/2510.25255) | [PDF](https://arxiv.org/pdf/2510.25255.pdf)
...
**提出时间最优控制方法以最小化液体溢出，实现松散放置液杯沿预设路径快速运输**

**关键词**: `机器人轨迹规划` `液体晃动控制` `最优控制问题` `直接多重打靶法` `动态建模`

## 📋 核心要点

1. 核心问题：机器人操纵松散放置液杯时，轨迹规划与控制困难，易导致液体溢出
2. 方法要点：结合晃动动力学模型，采用直接多重打靶法求解最优控制问题
3. 实验或效果：未知具体实验细节，但旨在最小化晃动，避免液体溢出

...
**提出EndoSight AI深度学习架构，实现实时胃肠道息肉检测与分割以增强内窥镜诊断。**

**关键词**: `息肉检测` `息肉分割` `深度学习` `内窥镜诊断` `实时推理` `热感知训练`

## 📋 核心要点

1. 核心问题：内窥镜过程中实时精确检测胃肠道息肉对早期诊断结直肠癌至关重要。
2. 方法要点：基于Hyper-Kvasir数据集开发深度学习模型，结合热感知程序提升鲁棒性。
3. 实验或效果：检测mAP达88.3%，分割Dice系数最高69%，实时推理速度超35帧/秒。

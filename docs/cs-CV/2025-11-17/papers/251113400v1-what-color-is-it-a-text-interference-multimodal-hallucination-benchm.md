...
**arXiv**: [2511.13400v1](https://arxiv.org/abs/2511.13400) | [PDF](https://arxiv.org/pdf/2511.13400.pdf)
...
**提出'What Color Is It'基准以解决多模态大模型颜色感知幻觉问题**

**关键词**: `多模态大模型` `视觉幻觉` `颜色感知` `基准数据集` `模型鲁棒性`

## 📋 核心要点

1. 多模态大模型易受文本干扰，在颜色感知中产生视觉幻觉。
2. 构建新基准数据集，通过简单方法触发单模态视觉幻觉。
3. 分析幻觉成因并提出增强模型鲁棒性的潜在解决方案。

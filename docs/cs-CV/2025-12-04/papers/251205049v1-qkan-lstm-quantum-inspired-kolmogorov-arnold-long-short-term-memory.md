...
**提出QKAN-LSTM以解决LSTM参数冗余和非线性表达能力不足的问题，应用于序列建模任务。**

**关键词**: `量子启发神经网络` `长短期记忆网络` `序列建模` `参数优化` `非线性激活函数` `城市电信预测`

## 📋 核心要点

1. 传统LSTM存在高参数冗余和有限非线性表达能力的问题。
2. 集成DARUAN模块作为量子变分激活函数，增强频率适应性和谱表示，无需多量子比特纠缠。
3. 在三个数据集上实验显示，参数减少79%且预测准确性和泛化能力优于经典LSTM。

...
**arXiv**: [2512.04938v1](https://arxiv.org/abs/2512.04938) | [PDF](https://arxiv.org/pdf/2512.04938.pdf)
...
**提出整合语音AI与关系图变换器，实现罕见神经疾病的连续神经认知监测。**

**关键词**: `连续神经认知监测` `语音AI` `关系图变换器` `罕见神经疾病` `异质医疗数据`

## 📋 核心要点

1. 核心问题：罕见神经疾病患者的认知症状（如'脑雾'）难以通过传统测试检测。
2. 方法要点：利用智能手机语音分析结合关系图变换器架构，处理异质医疗数据（语音、实验室结果、评估）。
3. 实验或效果：在苯丙酮尿症概念验证中，语音衍生的'言语流利度'与血液苯丙氨酸水平相关，优于标准认知测试。

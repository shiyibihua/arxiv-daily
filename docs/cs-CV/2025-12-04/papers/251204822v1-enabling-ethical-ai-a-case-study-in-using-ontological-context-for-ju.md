...
**arXiv**: [2512.04822v1](https://arxiv.org/abs/2512.04822) | [PDF](https://arxiv.org/pdf/2512.04822.pdf)
...
**提出基于本体上下文的人机协作方法，以构建可检查的语义层，实现可辩护的自主AI决策。**

**关键词**: `自主AI` `本体上下文` `语义层` `人机协作` `可辩护决策` `机构知识管理`

## 📋 核心要点

1. 核心问题：自主AI决策缺乏透明性和可辩护性，依赖后验解释而非实时可检查证据。
2. 方法要点：AI代理从多源数据生成候选知识结构，领域专家验证和扩展，形成迭代改进的语义层。
3. 实验或效果：该方法捕获隐性机构知识，提升响应质量和效率，缓解机构失忆，支持专家与非专家访问推理。

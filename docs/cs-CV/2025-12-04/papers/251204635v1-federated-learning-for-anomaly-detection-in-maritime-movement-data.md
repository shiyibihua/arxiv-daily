...
**arXiv**: [2512.04635v1](https://arxiv.org/abs/2512.04635) | [PDF](https://arxiv.org/pdf/2512.04635.pdf)
...
**提出M3fed以解决海上移动数据异常检测中的隐私和通信成本问题**

**关键词**: `联邦学习` `异常检测` `海上移动数据` `数据隐私` `通信成本优化`

## 📋 核心要点

1. 核心问题：海上移动数据异常检测中数据隐私和通信成本高
2. 方法要点：采用新颖的联邦学习策略训练M3fed模型
3. 实验或效果：基于AIS数据实验，评估通信成本和模型质量

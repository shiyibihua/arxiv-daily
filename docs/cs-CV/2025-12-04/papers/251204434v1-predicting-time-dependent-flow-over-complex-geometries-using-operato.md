...
**提出时间依赖的几何感知深度算子网络，以预测参数化和非参数化形状周围的中等雷诺数非定常流场。**

**关键词**: `非定常流预测` `深度算子网络` `几何感知建模` `计算流体力学代理` `符号距离场` `误差分析`

## 📋 核心要点

1. 核心问题：快速、几何泛化的非定常流代理模型仍具挑战性。
2. 方法要点：使用符号距离场编码几何和CNN分支编码流历史，基于841个高保真模拟训练。
3. 实验或效果：在未见形状上实现约5%相对L2单步误差，比CFD加速高达1000倍，但精细尾流中误差累积。

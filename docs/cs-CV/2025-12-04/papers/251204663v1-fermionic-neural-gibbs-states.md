...
**arXiv**: [2512.04663v1](https://arxiv.org/abs/2512.04663) | [PDF](https://arxiv.org/pdf/2512.04663.pdf)
...
**提出费米子神经吉布斯态以模拟强相互作用费米子的有限温度性质**

**关键词**: `费米子神经网络` `有限温度量子态` `强关联系统` `费米-哈伯德模型` `虚时演化`

## 📋 核心要点

1. 核心问题：强相互作用费米子在有限温度下的性质模拟，传统方法难以处理大系统尺寸
2. 方法要点：基于平均场热场双重态，结合神经网络变换和虚时演化构建强关联
3. 实验或效果：应用于掺杂费米-哈伯德模型，准确再现宽温度、相互作用强度和掺杂范围的热能

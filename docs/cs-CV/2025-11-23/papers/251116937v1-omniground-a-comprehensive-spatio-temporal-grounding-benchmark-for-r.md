...
**提出OmniGround基准和PG-TAF框架以解决复杂场景时空视频定位问题**

**关键词**: `时空视频定位` `基准构建` `训练免费框架` `多模态语言模型` `复杂查询处理`

## 📋 核心要点

1. 核心问题：现有STVG模型在真实复杂场景中表现不佳，存在类别偏见和推理简化问题
2. 方法要点：引入OmniGround基准和PG-TAF训练免费框架，分解时空定位任务
3. 实验或效果：PG-TAF在OmniGround上m_tIoU和m_vIoU分别提升25.6%和35.6%

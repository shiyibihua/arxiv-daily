...
**提出Pareto最优视觉导航框架，结合语义、决策和视觉伺服，实现实时复杂环境导航。**

**关键词**: `视觉导航` `Pareto最优决策` `图像空间处理` `语义理解` `实时系统`

## 📋 核心要点

1. 核心问题：传统导航方法在复杂环境中存在失败、高成本或泛化性差的问题。
2. 方法要点：在图像空间中集成数据驱动语义、Pareto最优决策和视觉伺服。
3. 实验或效果：未知，但声称轻量级且适用于实时导航。

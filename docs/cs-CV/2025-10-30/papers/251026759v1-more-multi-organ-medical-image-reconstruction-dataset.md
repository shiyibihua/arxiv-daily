...
**提出MORE数据集以解决CT重建模型泛化能力不足问题**

**关键词**: `CT重建` `多器官数据集` `模型泛化` `医学图像处理` `深度学习基准`

## 📋 核心要点

1. 核心问题：当前CT重建方法局限于特定解剖结构，泛化能力差
2. 方法要点：构建多器官CT数据集，涵盖9种解剖结构和15种病变类型
3. 实验或效果：数据集提升模型泛化，优化方法增强对未知解剖的鲁棒性

...
**提出SurveyEval基准以全面评估LLM生成的学术综述系统**

**关键词**: `LLM评估` `学术综述生成` `基准测试` `多维度评估` `人机对齐`

## 📋 核心要点

1. 核心问题：LLM自动生成综述系统的评估方法尚不完善，缺乏标准化基准
2. 方法要点：构建SurveyEval基准，从整体质量、大纲连贯性和引用准确性三个维度评估
3. 实验或效果：在7个学科上测试，显示专用系统优于通用长文本生成系统，评估结果与人类对齐

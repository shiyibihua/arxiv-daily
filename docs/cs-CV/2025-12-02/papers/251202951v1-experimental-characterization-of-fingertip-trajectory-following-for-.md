...
**arXiv**: [2512.02951v1](https://arxiv.org/abs/2512.02951) | [PDF](https://arxiv.org/pdf/2512.02951.pdf)
...
**提出基于解析运动学的三自由度串并联机器人手指，实现毫米级精度的任务空间轨迹跟踪。**

**关键词**: `机器人手指` `任务空间控制` `解析运动学` `轨迹跟踪` `灵巧操作` `实验表征`

## 📋 核心要点

1. 核心问题：紧凑型多自由度机器人手指的任务空间轨迹跟踪精度不足，影响灵巧操作。
2. 方法要点：采用解析前向运动学和闭式雅可比矩阵，实施解析运动速率控制方案。
3. 实验或效果：通过直线、圆形等轨迹实验，验证了毫米级跟踪精度，为灵巧操作提供基准。

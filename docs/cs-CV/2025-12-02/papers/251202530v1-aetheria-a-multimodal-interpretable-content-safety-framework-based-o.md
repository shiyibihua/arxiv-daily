...
**提出Aetheria多模态可解释内容安全框架，基于多智能体辩论与协作解决数字内容安全挑战。**

**关键词**: `多模态内容安全` `多智能体辩论` `可解释AI` `RAG知识检索` `内容审核框架`

## 📋 核心要点

1. 核心问题：数字内容激增，现有单模型或固定流水线系统在识别隐含风险和提供可解释判断过程方面存在局限。
2. 方法要点：采用五核心智能体协作架构，通过基于RAG知识检索的动态辩论机制，对多模态内容进行深度分析和裁决。
3. 实验或效果：在AIR-Bench基准上验证，Aetheria生成详细可追溯审计报告，在整体内容安全准确性，尤其是隐含风险识别上优于基线。

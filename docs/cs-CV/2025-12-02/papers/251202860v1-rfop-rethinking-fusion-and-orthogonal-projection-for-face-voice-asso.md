...
**arXiv**: [2512.02860v1](https://arxiv.org/abs/2512.02860) | [PDF](https://arxiv.org/pdf/2512.02860.pdf)
...
**提出重新思考融合与正交投影方法，以增强多语言环境下的面部-语音关联性能。**

**关键词**: `面部-语音关联` `多模态融合` `正交投影` `多语言环境` `FAME挑战`

## 📋 核心要点

1. 核心问题：多语言环境下面部-语音关联任务，涉及英语-德语数据对。
2. 方法要点：通过有效聚焦两种模态的相关语义信息，重新设计融合和正交投影策略。
3. 实验或效果：在FAME 2026挑战中排名第三，达到33.1%的等错误率。

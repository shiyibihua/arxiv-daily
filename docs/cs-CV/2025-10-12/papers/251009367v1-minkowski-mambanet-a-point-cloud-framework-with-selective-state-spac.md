...
**提出Minkowski-MambaNet框架，结合选择性状态空间模型，从LiDAR点云直接估计森林生物量**

**关键词**: `点云处理` `选择性状态空间模型` `森林生物量估计` `LiDAR数据分析` `深度学习框架`

## 📋 核心要点

1. 核心问题：点云中长程依赖建模困难，影响树木区分和生物量估计准确性
2. 方法要点：集成Mamba的选择性状态空间模型到Minkowski网络，增强全局上下文编码
3. 实验或效果：在丹麦国家森林清单数据上，显著优于现有方法，无需DTM且鲁棒

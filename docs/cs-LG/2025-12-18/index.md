---
layout: default
title: arXiv 中文要点汇总 - cs.LG - 2025-12-18
---
...
<a href="#支柱九具身大模型-embodied-foundation-models" class="interest-badge">支柱九：具身大模型 (Embodied Foundation Models) (11)</a>
<a href="#支柱二rl算法与架构-rl-architecture" class="interest-badge">支柱二：RL算法与架构 (RL & Architecture) (6)</a>
...
<h2 id="支柱九具身大模型-embodied-foundation-models">🔬 支柱九：具身大模型 (Embodied Foundation Models) (11 篇)</h2>
...
<tr>
  <td>1</td>
  <td><a href="./papers/251216334v1-pretrained-battery-transformer-pbt-a-battery-life-prediction-foundat.html">Pretrained Battery Transformer (PBT): A battery life prediction foundation model</a></td>
  <td>提出预训练电池Transformer（PBT），用于电池寿命预测，显著提升泛化性能。</td>
  <td class="tags-cell"><span class="paper-tag">foundation model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16334v1" data-paper-url="./papers/251216334v1-pretrained-battery-transformer-pbt-a-battery-life-prediction-foundat.html" onclick="toggleFavorite(this, '2512.16334v1', 'Pretrained Battery Transformer (PBT): A battery life prediction foundation model')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>2</td>
  <td><a href="./papers/251216244v1-coarse-to-fine-open-set-graph-node-classification-with-large-languag.html">Coarse-to-Fine Open-Set Graph Node Classification with Large Language Models</a></td>
  <td>提出CFC框架，利用大语言模型实现图节点开放集分类与细粒度OOD识别。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16244v1" data-paper-url="./papers/251216244v1-coarse-to-fine-open-set-graph-node-classification-with-large-languag.html" onclick="toggleFavorite(this, '2512.16244v1', 'Coarse-to-Fine Open-Set Graph Node Classification with Large Language Models')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>3</td>
...
<tr>
  <td>4</td>
  <td><a href="./papers/251216901v1-impacts-of-racial-bias-in-historical-training-data-for-news-ai.html">Impacts of Racial Bias in Historical Training Data for News AI</a></td>
  <td>揭示新闻AI中历史数据偏见：以纽约时报语料库为例，分析种族标签的影响。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16901v1" data-paper-url="./papers/251216901v1-impacts-of-racial-bias-in-historical-training-data-for-news-ai.html" onclick="toggleFavorite(this, '2512.16901v1', 'Impacts of Racial Bias in Historical Training Data for News AI')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>5</td>
  <td><a href="./papers/251216676v1-dataflow-an-llm-driven-framework-for-unified-data-preparation-and-wo.html">DataFlow: An LLM-Driven Framework for Unified Data Preparation and Workflow Automation in the Era of Data-Centric AI</a></td>
  <td>DataFlow：一个LLM驱动的统一数据准备与工作流自动化框架</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16676v1" data-paper-url="./papers/251216676v1-dataflow-an-llm-driven-framework-for-unified-data-preparation-and-wo.html" onclick="toggleFavorite(this, '2512.16676v1', 'DataFlow: An LLM-Driven Framework for Unified Data Preparation and Workflow Automation in the Era of Data-Centric AI')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>6</td>
...
<tr>
  <td>11</td>
  <td><a href="./papers/251216134v1-staggered-batch-scheduling-co-optimizing-time-to-first-token-and-thr.html">Staggered Batch Scheduling: Co-optimizing Time-to-First-Token and Throughput for High-Efficiency LLM Inference</a></td>
  <td>提出交错批调度(SBS)，优化DP+EP架构下LLM推理的首Token延迟和吞吐量。</td>
  <td class="tags-cell"><span class="paper-tag">large language model</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16134v1" data-paper-url="./papers/251216134v1-staggered-batch-scheduling-co-optimizing-time-to-first-token-and-thr.html" onclick="toggleFavorite(this, '2512.16134v1', 'Staggered Batch Scheduling: Co-optimizing Time-to-First-Token and Throughput for High-Efficiency LLM Inference')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  <td>12</td>
  <td><a href="./papers/251216565v1-non-asymptotic-global-convergence-of-ppo-clip.html">Non-Asymptotic Global Convergence of PPO-Clip</a></td>
  <td>提出PPO-Clip算法的非渐近全局收敛性分析</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.16565v1" data-paper-url="./papers/251216565v1-non-asymptotic-global-convergence-of-ppo-clip.html" onclick="toggleFavorite(this, '2512.16565v1', 'Non-Asymptotic Global Convergence of PPO-Clip')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>13</td>
